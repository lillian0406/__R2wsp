...
class LocalUniFeatureExtractor:
    ...
    def __init__(
        ...
        *,
        ...
        # Follow the official UNI README: resize to 224 and use ImageNet normalization.
...
def main() -> None:
    p = argparse.ArgumentParser(description="Extract UNI-based WSI feats_h5 for official survival split slides from raw SVS.")
